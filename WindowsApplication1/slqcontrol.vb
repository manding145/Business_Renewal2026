...
Module slqcontrol
    ...
    Public Class sqlcontrol
        Private dbcon As New MySqlConnection("datasource=10.0.14.117;database='businessportal';username=usera2;password=passa2;")
        '  Private dbcon As New MySqlConnection("datasource=localhost;database='businessportal';username=usera2;password=passa2;")
