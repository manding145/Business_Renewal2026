...
Public Class sqlcontrolgeo
    ' Private dbcon As New SqlConnection("Server=10.0.0.2;Database=Georecords;USER=sa;PASSWORD=@dm1n1str@t0r;")
    ...
    Public Sub AddRecord(ByVal Username As String, ByVal PAYTO As String, ByVal Amount As Decimal, ByVal Amountwords As String, ByVal strDate As String)
        Try
            Dim StrInsertRecord As String = "INSERT INTO bankchecks (username,payto,amount,amountwords,strdate)" &
                                      "VALUES (" &
                                      "'" & Username & "'," &
                                      "'" & PAYTO & "'," &
                                      "'" & Amount & "'," &
